# Alfred.Core Backend Makefile - Development & Production

# Configuration
PROJECT=src/Alfred.Core.Infrastructure
STARTUP=src/Alfred.Core.WebApi
CLI_PROJECT=src/Alfred.Core.Cli
OUTPUT_DIR=Migrations

DOCKER_IMAGE=alfred-core
DOCKER_TAG=latest
...
help:
	@echo "======================================"
	@echo "Alfred.Core Development & Production Tool"
	@echo "======================================"
	@echo ""
...
prod-health:
	...
	@if curl -sf http://localhost:8000/health/core > /dev/null 2>&1; then \
		echo "  ✅ Core API is healthy"; \
	else \
		echo "  ⏳ Core API still starting..."; \
	fi

prod-seed:
	@echo "🌱 Seeding production database..."
	docker exec alfred-core-prod dotnet Alfred.Core.Cli.dll seed
	@echo "✅ Seed complete!"

prod-db-shell:
	@echo "🗄️  Connecting to PostgreSQL..."
	docker exec alfred-postgres-prod psql -U $${DB_USER:-alfred} -d $${DB_NAME:-alfred_core}
