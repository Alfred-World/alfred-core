...
public sealed class Commodity : BaseEntity, IHasCreationTime
{
    ...
    public void Update(string name, CommodityAssetClass assetClass, Guid? defaultUnitId, string? description)
    {
        Name = name;
        AssetClass = assetClass;
        DefaultUnitId = defaultUnitId;
