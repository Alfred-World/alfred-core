...
namespace Alfred.Core.Infrastructure.Migrations
{
    ...
    [Migration("20260324135108_AddSourceAccount")]
    partial class AddSourceAccount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Alfred.Core.Domain.Entities.SourceAccount", b =>
                {
                    ...
                    b.HasIndex("AccountType", "Username");
            ...
            modelBuilder.Entity("Alfred.Core.Domain.Entities.AccountClone", b =>
                {
                    ...
                    b.HasOne("Alfred.Core.Domain.Entities.SourceAccount", "SourceAccount")
                        .WithMany("Clones")
