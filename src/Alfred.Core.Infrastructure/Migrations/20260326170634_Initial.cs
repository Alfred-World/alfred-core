    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sales_bonus_tiers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableBalance = table.Column<decimal>(type: "numeric(15,2)", nullable: false, defaultValue: 0m),
                    TotalEarned = table.Column<decimal>(type: "numeric(15,2)", nullable: false, defaultValue: 0m),
                    TotalPaidOut = table.Column<decimal>(type: "numeric(15,2)", nullable: false, defaultValue: 0m),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_commissions_members_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateTable(
                name: "member_monthly_sales_summaries",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "generate_uuid_v7()"),
                    SoldByMemberId = table.Column<Guid>(type: "uuid", nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: false),
                    Month = table.Column<int>(type: "integer", nullable: false),
                    OrderCount = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    HighestTierReachedId = table.Column<Guid>(type: "uuid", nullable: true),
                    TotalBonusEarned = table.Column<decimal>(type: "numeric(15,2)", nullable: false, defaultValue: 0m),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_member_monthly_sales_summaries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_member_monthly_sales_summaries_members_SoldByMemberId",
                        column: x => x.SoldByMemberId,
                        principalTable: "members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_member_monthly_sales_summaries_sales_bonus_tiers_HighestTie~",
                        column: x => x.HighestTierReachedId,
                        principalTable: "sales_bonus_tiers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "sales_bonus_transactions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "generate_uuid_v7()"),
                    SoldByMemberId = table.Column<Guid>(type: "uuid", nullable: false),
                    SalesBonusTierId = table.Column<Guid>(type: "uuid", nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: false),
                    Month = table.Column<int>(type: "integer", nullable: false),
                    OrderCountAtTrigger = table.Column<int>(type: "integer", nullable: false),
                    OrderThresholdSnapshot = table.Column<int>(type: "integer", nullable: false),
                    BonusAmountSnapshot = table.Column<decimal>(type: "numeric(15,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sales_bonus_transactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_sales_bonus_transactions_members_SoldByMemberId",
                        column: x => x.SoldByMemberId,
                        principalTable: "members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_sales_bonus_transactions_replicated_users_ProcessedByUserId",
                        column: x => x.ProcessedByUserId,
                        principalTable: "replicated_users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_sales_bonus_transactions_sales_bonus_tiers_SalesBonusTierId",
                        column: x => x.SalesBonusTierId,
                        principalTable: "sales_bonus_tiers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefundAmount = table.Column<decimal>(type: "numeric(15,2)", nullable: false, defaultValue: 0m),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "generate_uuid_v7()"),
                    MemberId = table.Column<Guid>(type: "uuid", nullable: false),
                    AccountOrderId = table.Column<Guid>(type: "uuid", nullable: true),
                    TransactionType = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    Amount = table.Column<decimal>(type: "numeric(15,2)", nullable: false),
                    BalanceAfter = table.Column<decimal>(type: "numeric(15,2)", nullable: false),
                    Note = table.Column<string>(type: "text", nullable: true),
                    EvidenceObjectKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "Pending"),
                    ProcessedByUserId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_commission_transactions_members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_commission_transactions_orders_AccountOrderId",
                        column: x => x.AccountOrderId,
                        principalTable: "orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_commission_transactions_replicated_users_ProcessedByUserId",
                        column: x => x.ProcessedByUserId,
                        principalTable: "replicated_users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "generate_uuid_v7()"),
                    AccountOrderId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_order_attachments_orders_AccountOrderId",
                        column: x => x.AccountOrderId,
                        principalTable: "orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_commission_transactions_AccountOrderId",
                table: "commission_transactions",
                column: "AccountOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_commission_transactions_MemberId",
                table: "commission_transactions",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_commission_transactions_ProcessedByUserId",
                table: "commission_transactions",
                column: "ProcessedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_commission_transactions_TransactionType",
                table: "commission_transactions",
                column: "TransactionType");

            migrationBuilder.CreateIndex(
                name: "IX_commissions_MemberId",
                table: "commissions",
                column: "MemberId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_member_monthly_sales_summaries_HighestTierReachedId",
                table: "member_monthly_sales_summaries",
                column: "HighestTierReachedId");

            migrationBuilder.CreateIndex(
                name: "IX_member_monthly_sales_summaries_SoldByMemberId_Year_Month",
                table: "member_monthly_sales_summaries",
                columns: new[] { "SoldByMemberId", "Year", "Month" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_order_attachments_AccountOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sales_bonus_tiers_OrderThreshold",
                table: "sales_bonus_tiers",
                column: "OrderThreshold",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_sales_bonus_transactions_ProcessedByUserId",
                table: "sales_bonus_transactions",
                column: "ProcessedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_sales_bonus_transactions_SalesBonusTierId",
                table: "sales_bonus_transactions",
                column: "SalesBonusTierId");

            migrationBuilder.CreateIndex(
                name: "IX_sales_bonus_transactions_SoldByMemberId",
                table: "sales_bonus_transactions",
                column: "SoldByMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_sales_bonus_transactions_SoldByMemberId_Year_Month",
                table: "sales_bonus_transactions",
                columns: new[] { "SoldByMemberId", "Year", "Month" });
