...
using Alfred.Core.Infrastructure.Services.Email.Providers;

using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Logging;

namespace Alfred.Core.Infrastructure.Services.Email;
        ...
        IConfiguration configuration)
    {
        ...
        services.AddSingleton<IEmailQueue>(sp =>
        {
            try
            {
                ...
                var logger = sp.GetRequiredService<ILogger<CacheEmailQueue>>();
