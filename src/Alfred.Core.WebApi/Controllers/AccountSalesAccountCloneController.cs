...
public sealed class AccountSalesAccountCloneController : BaseApiController
{
    ...
    public async Task<IActionResult> UpdateAccountClone(Guid accountCloneId,
        ...
        CancellationToken cancellationToken)
    {
        var result = await _service.UpdateAccountCloneAsync(accountCloneId, request.ToDto(), cancellationToken);
    ...
    public async Task<IActionResult> ReviewAccountClone(Guid accountCloneId,
        ...
        CancellationToken cancellationToken)
    {
        var result = await _service.ReviewAccountCloneAsync(accountCloneId, request.ToDto(), cancellationToken);
        return OkResponse(result);
    }
    ...
    public async Task<IActionResult> UpdateAccountCloneStatus(Guid accountCloneId,
        ...
        CancellationToken cancellationToken)
    {
        var result = await _service.UpdateAccountCloneStatusAsync(accountCloneId, request.ToDto(), cancellationToken);
        return OkResponse(result);
    }
}
