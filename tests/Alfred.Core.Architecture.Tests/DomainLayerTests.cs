...
namespace Alfred.Core.Architecture.Tests;
...
{
    private const string DomainNamespace = "Alfred.Core.Domain";
    private const string ApplicationNamespace = "Alfred.Core.Application";
    private const string InfrastructureNamespace = "Alfred.Core.Infrastructure";
    private const string WebApiNamespace = "Alfred.Core.WebApi";
